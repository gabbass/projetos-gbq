...
export default async function ProgressPage() {
  ...
  const metrics = [
    ...
    { label: "Tarefas aguardando", value: `${summary.waitingCount}`, note: "tarefas principais que dependem de uma ação", icon: AlertCircle, color: "text-blue-600 bg-blue-500/10" },
    { label: "Total de tarefas", value: `${summary.taskCount}`, note: "tarefas principais em todos os projetos", icon: FolderKanban, color: "text-amber-600 bg-amber-500/10" },
  ]
